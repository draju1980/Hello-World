# Write a function that accepts a list of integers and returns a new list which is the sorted version
# (ascending order) of the original list (Original list should not be modified).
